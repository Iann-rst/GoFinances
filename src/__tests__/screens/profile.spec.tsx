...
describe('Profile Screen', () => {
  it('Verifica se o input com placeholder name está correto na tela', () => {
  ...
  it('Verificar se dados do usuário foram carregados', () => {
  ...
  it('Verifica se o titulo Perfil renderizou correto', () => {
    const { getByTestId } = render(<Profile />);
